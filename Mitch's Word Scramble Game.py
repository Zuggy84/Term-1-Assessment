...
#Game Introduction:
    ...
    os.system('cls')
    game_player_name=colour.purple+colour.bold+game_player_name+colour.end
    print(colour.cyan+'Hello {}'.format(game_player_name)+colour.cyan+', Nice of You to Play this Game!'+colour.end)
    print()
...
#Easy Difficulty:
    if difficulty_selection=='easy' or difficulty_selection=='Easy' or difficulty_selection=='EASY' or difficulty_selection=='e' or difficulty_selection=='E' or difficulty_selection=='1':
        os.system('cls')
        game_difficulty_name=colour.green+'Easy'+colour.end
        print()
